...
const Hero = ({ setCurrentPage }) => {
  ...
  return (
    <>
      <div className="relative overflow-hidden bg-gradient-to-br from-dark-600 via-dark-500 to-dark-700 py-20 md:py-32">
          ...
          >
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-400 mb-6">
                <span className="bg-dark-600 px-3 py-1 rounded-full">550 tonnes CO₂ pour entraîner GPT-3</span>
                <span className="bg-dark-600 px-3 py-1 rounded-full">700 m³ d'eau pour l'entraînement</span>
                <span className="bg-dark-600 px-3 py-1 rounded-full">×100 plus polluant : GPT-4 vs GPT-3.5</span>
              </div>
              <div className="text-center">
                <a 
      ...
      {/* Section Interactive ajoutée */}
      <div id="interactive-section">
        <InteractiveHeroSection setCurrentPage={setCurrentPage} />
      </div>
    </>
  );
};
